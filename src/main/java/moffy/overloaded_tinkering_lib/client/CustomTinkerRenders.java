package moffy.overloaded_tinkering_lib.client;

import com.mojang.blaze3d.vertex.PoseStack;
import moffy.overloaded_tinkering_lib.Config;
import moffy.overloaded_tinkering_lib.client.model.TinkerModelMap;
...
import moffy.overloaded_tinkering_lib.client.shader.TinkerShaderMap;
...
public class CustomTinkerRenders {
    ...
    public static void renderQuadsTasks(
        ...
        List<RenderTasks.RenderTask> renderQueue = new ArrayList<>();
        ...
        for (RenderTasks.RenderTask task : renderQueue) {
    ...
    public interface RenderTaskProcessor {
        List<RenderTasks.RenderTask> getRenderTasks(RenderType renderType, List<BakedQuad> quads);
    }
}
